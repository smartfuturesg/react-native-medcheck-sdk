//
//  DeviceUserProfiles+CoreDataClass.m
//  BPTracker
//
...
@implementation DeviceUserProfiles
                                             ...
                                             context:(NSManagedObjectContext *)context
{
    ...
    DeviceUser *deviceUser = [DeviceUser bindDeviceUserWithUserID:[userProfilesInfo valueForKeyPath:KEY_USER_PROFILES_ID] inManagedObjectContext:context];
    
    oldUserProfiles.whoSet = deviceUser;
